  ...
  return (
    <Layout>
      <div className="about-us">
        ...
        <p className="intro-p">
           " <span className="random">TechNova Software</span> specializes in providing comprehensive software
        ...
        <section className="service-section">
          <div className="service">
            ...
            <div className="service-description add ">
              ...
              <p>
                <h3 className="aboutspan">Custom Software Development:</h3>{" "}
          ...
          <div className="service">
            ...
            <div className="service-description ">
              ...
              <p>
                <h3 className="aboutspan">Technical Training Programs:</h3>{" "}
          ...
          <div className="service">
            ...
            <div className="service-description add  change" >
              ...
              <p>
                <h3 className="aboutspan">Project Management:</h3> We
